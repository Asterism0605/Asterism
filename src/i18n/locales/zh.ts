...
export default {
  ...
  consult: {
    ...
    matchedConsultantNone: '目前沒有可配對的顧問',
    matchedConsultantLoadError: '顧問資料載入失敗,請稍後再試。',
    matchedConsultantUnavailable: '顧問資料暫時無法取得。',
    savingLocation: '儲存中…',
    ...
    locationOnlineLabel: '諮詢連結',
    locationInPersonLabel: '諮詢地址',
    locationOnlinePlaceholder: '貼上 Google Meet 等會議連結',
  ...
  dna: {
    ...
    resultYour: '你的',
    homepagePersonalized: '你的首頁\n已根據\n你的 Style DNA\n個人化',
    scrollToSimilarStyles: '向下滑動',
    retakeQuiz: '重新測驗',
